import numpy as np
from .projection import project3Dto2D

cat_names = ['dog house','dog house left','dog house right','dog house center','house','house long','whole ship',"super structure",'landing pad','ship stern',"Mast",'pelican case']
...
def cat_points(cat_id = 1):
    ...
    if cat_id == cat_names_to_id("dog house right"): #3
        P = np.array([[2.11022, 2.7533, 0],[1.94844, 2.7533, 1.55987],[0, 2.7533, 1.6133],[0, 2.7533, 0],
                      [2.11022, 3.82, 0],[1.94844, 3.82, 1.55987],[0, 3.82, 1.6133],[0, 3.82, 0]])
...
PW_label = np.array([
    [-1.83, 2.77969 ,0.022108],
    [-1.02 , 2.75591, 1.43],
    [-1.02, 2.7797 ,0.022135],
    [2.11023, 2.78005 ,0.000189],
    [1.94845, 2.75423 ,1.55987],
    
    [-0.30205,2.7576 ,1.325],
    [-0.30205,2.75935 ,0.675],
    [0.35795,2.75935  ,0.675],
    [0.35795,2.74521 ,1.325 ],

    [-0.092558,2.43173 ,0.010196],
    [-0.090053 ,0.938342 ,0.006117],
    [0.078511,0.938342 ,0.006117],
    [0.078405,2.43032 ,0.010117],

    [-0.090053, 0.77881, 0.006117],
    [-0.090553, -0.77881, 0.006117],
    [0.084596, -0.77881, 0.006117],
    [0.078511, 0.77881, 0.006117],

    [-0.089802,-0.938342  ,0.006117 ],
    [-0.079617  ,-2.40852 ,0.005059],
    [0.097575 ,-2.40978 ,0.005108 ],
    [0.08547 ,-0.938342  ,0.006117],

    [-3.02197,2.60146  ,0.009872 ],
    [-2.91501  ,-2.51464  ,0.004129],
    [2.84957  ,-2.55869 ,0.005731 ],
    [2.97102  ,2.58878   ,0.010833],

    [-3.33511, 2.78004, 0.000195],
    [-3.13876 , -2.92091, 0.000195],
    [3.13876, -2.92091 , 0.000195],
    [3.33434, 2.78004, 0.000195],

    [-0.00000 , 3.7508, 2.56107],
    [-1.94845 , 3.77276, 1.57398 ],
    [1.94845 , 3.77276 , 1.57398 ],

    [-3.13876, -2.92091, -0.264447],
    [3.13876, -2.92091, -0.264447],

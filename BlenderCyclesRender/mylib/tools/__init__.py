...
cat_names = ['dog house','dog house left','dog house right','dog house center','house','house long','whole ship','landing pad','ship stern',"Mast",'pelican case']
...
def cat_points(cat_id = 1):
    ...
    if cat_id == cat_names_to_id("dog house right"): #3
        P = np.array([[2.11022, 2.7533, 0],[1.94844, 2.7533, 1.6133],[0, 2.7533, 1.55987],[0, 2.7533, 0],
                      [2.11022, 3.82, 0],[2.11022, 3.82, 1.6133],[0, 3.82, 1.55987],[0, 3.82, 0]])
